...
[![Commits since last version](https://img.shields.io/github/commits-since/ViennaRNA/ViennaRNA/v2.6.0)](https://github.com/ViennaRNA/ViennaRNA/compare/v2.5.1...v2.6.0)
...
```
tar -zxvf ViennaRNA-2.6.0.tar.gz
cd ViennaRNA-2.6.0
./configure
make
sudo make install
