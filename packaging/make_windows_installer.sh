...
arch64) echo "Making Windows Installer using Arch Linux mingw-w64 installation"
              ...
              ./configure --host=i686-w64-mingw32 ${CONFIGURE_OPTIONS} >>${WIN_INSTALLER_LOG} 2>&1
              make clean >>${WIN_INSTALLER_LOG} 2>&1
              make >>${WIN_INSTALLER_LOG} 2>&1
              makensis packaging/win_installer_archlinux_i686.nsi >>${WIN_INSTALLER_LOG} 2>&1
              echo -ne " done\n"
              echo -ne "...making 64bit version..."
              ./configure --host=x86_64-w64-mingw32 ${CONFIGURE_OPTIONS} >>${WIN_INSTALLER_LOG} 2>&1
              make clean >>${WIN_INSTALLER_LOG} 2>&1
              make >>${WIN_INSTALLER_LOG} 2>&1
              makensis packaging/win_installer_archlinux_x86_64.nsi >>${WIN_INSTALLER_LOG} 2>&1
              echo -ne " done\n"
              ;;
