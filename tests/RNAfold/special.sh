...
diff=$(${DIFF} -ru -I CreationDate -I Creator ${RNAFOLD_RESULTSDIR}/rnafold_theo_test_0001_dp.ps rnafold_theo_test_0001_dp.ps)
if [ "x${diff}" != "x" ] ; then failed; echo -e "$diff"; else passed; fi
...
do
  ...
  diff=$(${DIFF} -ru -I CreationDate -I test_circ test_circ_sc_0001_dp.ps test_circ_0001_dp.ps)
