...
**/
float  snofold(const char *sequence, const int max_assym, const int threshold, 
...
int    snoloop_energy(short * ptable, short *s, short *s1, int i);
...
char * alisnobacktrack_fold_from_pair(const char **sequence,int i, int j,int *cov);
