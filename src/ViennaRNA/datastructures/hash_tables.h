 ...
 */
vrna_hash_table *vrna_initialize_hash_table (unsigned int hash_bits, vrna_hash_entry_comparison *compare_function, vrna_hash_function *hash_function, vrna_free_hash_entry *free_hash_entry);
 ...
 */
void * vrna_lookup_hash (void *x, vrna_hash_table *ht);
 ...
 */
int vrna_write_hash (void *x, vrna_hash_table *ht);
 ...
 * @param ht - the hash table
 */
void vrna_delete_hash (void *x, vrna_hash_table *ht);
