                ...
                vrna_fold_compound_t  *vc)
{
  ...
  int                       e, decomp, en, i1k, k1j1, ij, k, *indx, turn, *rtype;
  vrna_param_t              *P;
  vrna_md_t                 *md;
  vrna_hc_t                 *hc;
  vrna_sc_t                 *sc;
                        ...
                        int                   *stack_count)
{
  ...
  int                       ii, jj, fij, fi, u, en, **c, **fML, **ggg,
                            turn, with_gquad, dangle_model, *rtype, kk, cnt;
  vrna_param_t              *P;
  vrna_md_t                 *md;
  vrna_hc_t                 *hc;
  vrna_sc_t                 *sc;
                  ...
                  int                   *component2)
{
  ...
  short                     s5, s3, *S1;
  unsigned int              *sn;
  int                       p, q, r, e, tmp_en, cp, turn, dangle_model,
                            **c, **fML, *rtype;
  vrna_param_t              *P;
  vrna_md_t                 *md;
  vrna_hc_t                 *hc;
